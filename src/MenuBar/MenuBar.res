...
let make = () => {
  ...
  <div id="footer" className=`${activeFooter} lg:ml-7 lg:mr-7 lg:h-96 shadow-md`>
    <ul id="nav-bar" className="flex flex-row justify-evenly w-full h-14 overflow-hidden rounded-t-xl bg-radiola-blue">
      ...
      <li className="flex flex-col justify-center flex-1 text-center cursor-pointer hover:bg-blue-400" onClick={(evt) => onClick(evt, DataContext.Selection.Tracker)}>
      ...
      <li className="flex flex-col justify-center flex-1 text-center cursor-pointer hover:bg-blue-400" onClick={(evt) => onClick(evt, DataContext.Selection.Directions)}>
      ...
      <li className="flex flex-col justify-center flex-1 text-center cursor-pointer hover:bg-blue-400" onClick={(evt) => onClick(evt, DataContext.Selection.Routes)}>
